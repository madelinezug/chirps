# Generated by Django 2.0.2 on 2018-03-27 04:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('submit_announce', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='announcements.Announcement')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='announcements.Individual')),
            ],
        ),
        migrations.CreateModel(
            name='SubmitTag',
        ...
        migrations.AddField(
            ...
            name='approver',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='approver', to='announcements.Individual'),
        ),
        migrations.AddField(
            model_name='announcement',
            name='submitter',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='submitter', to='announcements.Individual'),
        ),
        migrations.AddField(
